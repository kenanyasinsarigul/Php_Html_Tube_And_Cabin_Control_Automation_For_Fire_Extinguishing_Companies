...
!empty($soru8) || !empty($soru9) || !empty($soru10) || !empty($soru11) || !empty($soru12) || !empty($kontroltar) || !empty($sonrakontroltar) || !empty($bakimsonuc)){
    ...
    $updateydick=mysqli_query($connect,"UPDATE ydick SET dolapno='$dolapno', firma='$firma', bulyer='$bulyer', vergino='$vergino', ilgilikisi='$ilgilikisi', soru1='$soru1', soru2='$soru2', soru3='$soru3', soru4='$soru4', soru5='$soru5', soru6='$soru6', soru7='$soru7',
...
if (isset($_POST['deleteydick'])){

    $id=$_POST["iddeleteydick"];
  
    $deleteydick=mysqli_query($connect,"DELETE FROM ydick WHERE id='$id'");
  
      if($connect->query($deleteydick)){
