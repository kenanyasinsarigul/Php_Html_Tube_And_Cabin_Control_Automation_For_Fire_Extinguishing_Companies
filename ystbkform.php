...
<body>
	...
	<div class="merkez">
		<div class="contbas">
				<label class="form" style="font-weight: bold; text-transform: uppercase;">TÜP BAKIM VE KONTROL FORMU</label>
		</div>
		<form class="formekle" method="POST">
			<div class="form-group">
				<label>TÜP NO:</label>
				<input type="text" class="form-control" name="tupno" required>
			</div>
			<div class="form-group">
				<label>CİNSİ:</label>
				<input type="text" class="form-control" name="cinsi" required>
			</div>
			<div class="form-group">
				<label>FİRMA:</label>
			...
			<div class="form-group">
				<label>İMAL TARİHİ (YYYY):</label>
				<input type="text" placeholder="YYYY" class="form-control" name="imaltar" required>
			</div>
			<div class="form-group">
				<label>DOLUM TARİHİ:</label>
				<input type="date" class="form-control" name="dolumtar" required>
			</div>
			<div class="form-group">
				<label>TEKRAR DOLUM TARİHİ:</label>
				<input type="date" class="form-control" name="tekrardoltar" required>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				<label>DEĞİŞİM VARSA CİNSİ VE TARİHİ:</label>
			...
			<div class="form-group">
				<label>BİR SONRAKİ KONTROL TARİHİ (MM.YYYY):</label>
